// DS3231RTC Class is by Seeed Technology Inc(http://www.seeedstudio.com) and used
...
uint8_t DS3231RTC::readRegister(uint8_t regaddress)
{
...
void DS3231RTC::writeRegister(uint8_t regaddress,uint8_t value)
{
    Wire.beginTransmission(DS3231_ADDRESS);
    Wire.write((byte)regaddress);
...
void DS3231RTC::adjust(const DateTime& dt) {
...
void DS3231RTC::enableInterrupts(uint8_t periodicity)
{
...
void DS3231RTC::enableInterrupts(uint8_t hh24, uint8_t mm, uint8_t ss)
{
    unsigned char ctReg=0;
    ctReg |= 0b00011101; 
    writeRegister(DS3231_CONTROL_REG, ctReg);     //CONTROL Register Address
...
void DS3231RTC::disableInterrupts()
{
...
void DS3231RTC::convertTemperature()
{
    // Set CONV 
